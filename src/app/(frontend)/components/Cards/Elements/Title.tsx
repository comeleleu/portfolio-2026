...
export const Title = ({
    ...
    return (
        <div className="flex flex-col gap-1">
            <h3 className="flex items-center gap-4 text-xl font-semibold text-zinc-200">
                {title}
                {isLink && (
            ...
            {(subtitle || children) && (
                <div className={`flex flex-col md:flex-row md:items-center gap-1 md:gap-12 text-md ${subtitleColor}`}>
                    {subtitle && (
