...
export const Navbar = ({ sectionParameters }: { sectionParameters: any }) => {
    ...
    return (
        <div className="sticky top-0 z-50 flex flex-row sm:flex-col items-center w-screen sm:w-auto h-auto sm:h-screen px-2 sm:px-6 py-1 sm:py-10 overflow-hidden">
            <nav
            ...
            >
                {sectionParameters?.navbar?.links && sectionParameters.navbar.links.length > 0 && (
                    <>
                        ...
                        <div className="h-px sm:h-20 w-8 sm:w-px bg-zinc-600"></div>
                    </>
                )}
            ...
            <button
                ...
                className={`
                    ...
                    ${showScrollTop ? 'w-14 h-14 opacity-100 translate-0 ml-2 sm:ml-0 sm:mt-6'
